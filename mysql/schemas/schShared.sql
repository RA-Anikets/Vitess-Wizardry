...
--
-- Host: localhost    Database: schShared
-- ------------------------------------------------------
...
--
-- Current Database: `schShared`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `schShared` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
--
-- Table structure for table `tblAccountAddress`
--
...
--
-- Table structure for table `tblAccountAddressType`
--
...
--
-- Table structure for table `tblAccountLog`
--
...
--
-- Table structure for table `tblAccountLogDiscount`
--
...
--
-- Table structure for table `tblAccountLogOrder`
--
...
--
-- Table structure for table `tblAccountLogStatus`
--
...
--
-- Table structure for table `tblAccountLogType`
--
...
--
-- Table structure for table `tblAccountNotes`
--
...
--
-- Table structure for table `tblActivityLogStatus`
--
...
--
-- Table structure for table `tblActivityLogType`
--
...
--
-- Table structure for table `tblAddressGeocode`
--
...
--
-- Table structure for table `tblAffiliateProgram`
--
...
--
-- Table structure for table `tblApiConsumer`
--
...
--
-- Table structure for table `tblApiConsumerType`
--
...
--
-- Table structure for table `tblApiConsumerUsage`
--
...
--
-- Table structure for table `tblApiUsage`
--
...
--
-- Table structure for table `tblAppWindow`
--
...
--
-- Table structure for table `tblAssetActivityLog`
--
...
--
-- Table structure for table `tblAssetBusiness`
--
...
--
-- Table structure for table `tblAssetCategory`
--
...
--
-- Table structure for table `tblAssetCategoryBarcodeFormatType`
--
...
--
-- Table structure for table `tblAssetCategoryResolved`
--
...
--
-- Table structure for table `tblAssetClassification`
--
...
--
-- Table structure for table `tblAssetClassificationLog`
--
...
--
-- Table structure for table `tblAssetConsumingReference`
--
...
--
-- Table structure for table `tblAssetDepletionTracking`
--
...
--
-- Table structure for table `tblAssetEvent`
--
...
--
-- Table structure for table `tblAssetEventType`
--
...
--
-- Table structure for table `tblAssetEventTypeAsset`
--
...
--
-- Table structure for table `tblAssetOfflineTracker`
--
...
--
-- Table structure for table `tblAssetProperty`
--
...
--
-- Table structure for table `tblAssetPropertyDomainElement`
--
...
--
-- Table structure for table `tblAssetPropertyType`
--
...
--
-- Table structure for table `tblAssetPropertyValue`
--
...
--
-- Table structure for table `tblAssetPurchaseTracking`
--
...
--
-- Table structure for table `tblAssetResolved`
--
...
--
-- Table structure for table `tblAssetSelection`
--
...
--
-- Table structure for table `tblAssetStatus`
--
...
--
-- Table structure for table `tblAssetUser`
--
...
--
-- Table structure for table `tblAssetUserType`
--
...
--
-- Table structure for table `tblAuditLogArchive`
--
...
--
-- Table structure for table `tblAuthorization`
--
...
--
-- Table structure for table `tblBarcodeFormatType`
--
...
--
-- Table structure for table `tblBillingTaxes`
--
...
--
-- Table structure for table `tblBillingTerm`
--
...
--
-- Table structure for table `tblBillingType`
--
...
--
-- Table structure for table `tblBOMGroup`
--
...
--
-- Table structure for table `tblBOMGroupPart`
--
...
--
-- Table structure for table `tblBorgSetting`
--
...
--
-- Table structure for table `tblBusinessClassification`
--
...
--
-- Table structure for table `tblBusinessGroup`
--
...
--
-- Table structure for table `tblBusinessRole`
--
...
--
-- Table structure for table `tblBusinessRoleType`
--
...
--
-- Table structure for table `tblBusinessTypeDef`
--
...
--
-- Table structure for table `tblCalendarEvent`
--
...
--
-- Table structure for table `tblCategorySetting`
--
...
--
-- Table structure for table `tblChargeDepartment`
--
...
--
-- Table structure for table `tblClientSession`
--
...
--
-- Table structure for table `tblCohort`
--
...
--
-- Table structure for table `tblCrmMetrics`
--
...
--
-- Table structure for table `tblCrmMetricsSettings`
--
...
--
-- Table structure for table `tblCrmMetricsType`
--
...
--
-- Table structure for table `tblCrmMetricsTypeFormat`
--
...
--
-- Table structure for table `tblCrmMetricsUser`
--
...
--
-- Table structure for table `tblCustomField`
--
...
--
-- Table structure for table `tblCustomFieldValue`
--
...
--
-- Table structure for table `tblCustomQuery`
--
...
--
-- Table structure for table `tblCycleCount`
--
...
--
-- Table structure for table `tblDashboardDashboardPersona`
--
...
--
-- Table structure for table `tblDashboardFeatureNotice`
--
...
--
-- Table structure for table `tblDashboardPersona`
--
...
--
-- Table structure for table `tblDashboardWidget`
--
...
--
-- Table structure for table `tblDashboardWidgetCategory`
--
...
--
-- Table structure for table `tblDashboardWidgetDashboardPersona`
--
...
--
-- Table structure for table `tblDashboardWidgetParameter`
--
...
--
-- Table structure for table `tblDashboardWidgetPosition`
--
...
--
-- Table structure for table `tblDashboardWidgetPositionFilter`
--
...
--
-- Table structure for table `tblDashboardWidgetPositionParameter`
--
...
--
-- Table structure for table `tblDashboardWidgetQuery`
--
...
--
-- Table structure for table `tblDatabaseExport`
--
...
--
-- Table structure for table `tblDdColumn`
--
...
--
-- Table structure for table `tblDdColumnType`
--
...
--
-- Table structure for table `tblDdCustomTableRow`
--
...
--
-- Table structure for table `tblDdTable`
--
...
--
-- Table structure for table `tblDdTableType`
--
...
--
-- Table structure for table `tblDistributionBillingPlan`
--
...
--
-- Table structure for table `tblDistributionPaymentMethod`
--
...
--
-- Table structure for table `tblDistributionPricingTier`
--
...
--
-- Table structure for table `tblDistributionRecurringType`
--
...
--
-- Table structure for table `tblDistributionUnitPricingRule`
--
...
--
-- Table structure for table `tblEmailAddressSmtpEvent`
--
...
--
-- Table structure for table `tblEmailAddressStatus`
--
...
--
-- Table structure for table `tblEmailMessage`
--
...
--
-- Table structure for table `tblEpicFeatureNotice`
--
...
--
-- Table structure for table `tblEpicFeatureNoticePricingTier`
--
...
--
-- Table structure for table `tblExternalJobStatus`
--
...
--
-- Table structure for table `tblFeatureCategory`
--
...
--
-- Table structure for table `tblFeatureNoticeFilter`
--
...
--
-- Table structure for table `tblFeatureProperty`
--
...
--
-- Table structure for table `tblFeatureValueOverageControlType`
--
...
--
-- Table structure for table `tblFeatureValuePeriodType`
--
...
--
-- Table structure for table `tblFeatureValueType`
--
...
--
-- Table structure for table `tblFileContents`
--
...
--
-- Table structure for table `tblFirewall`
--
...
--
-- Table structure for table `tblFirewallLog`
--
...
--
-- Table structure for table `tblFirewallRule`
--
...
--
-- Table structure for table `tblGHGCalcAsset`
--
...
--
-- Table structure for table `tblGHGCalcCarbonMarket`
--
...
--
-- Table structure for table `tblGHGCalcFuel`
--
...
--
-- Table structure for table `tblGHGCalcGWP`
--
...
--
-- Table structure for table `tblGHGCalcLocation`
--
...
--
-- Table structure for table `tblGHGCalcResource`
--
...
--
-- Table structure for table `tblGHGCalcVehicle`
--
...
--
-- Table structure for table `tblGroupPermissions`
--
...
--
-- Table structure for table `tblGuestActions`
--
...
--
-- Table structure for table `tblGuestMrFormField`
--
...
--
-- Table structure for table `tblIdGen`
--
...
--
-- Table structure for table `tblIntegrationAction`
--
...
--
-- Table structure for table `tblIntegrationActionAdvancedEndpoint`
--
...
--
-- Table structure for table `tblIntegrationActionLog`
--
...
--
-- Table structure for table `tblIntegrationActionType`
--
...
--
-- Table structure for table `tblIntegrationConfigurableProperty`
--
...
--
-- Table structure for table `tblIntegrationEndpointFormat`
--
...
--
-- Table structure for table `tblIntegrationParameter`
--
...
--
-- Table structure for table `tblIntegrationParameterType`
--
...
--
-- Table structure for table `tblIntegrationProtocol`
--
...
--
-- Table structure for table `tblIntegrationSystem`
--
...
--
-- Table structure for table `tblIntegrationTemplate`
--
...
--
-- Table structure for table `tblIsoWeekCalendar`
--
...
--
-- Table structure for table `tblKpiResult`
--
...
--
-- Table structure for table `tblLastMeterReading`
--
...
--
-- Table structure for table `tblLeadState`
--
...
--
-- Table structure for table `tblLineItem`
--
...
--
-- Table structure for table `tblLocalization`
--
...
--
-- Table structure for table `tblLocalizationArchive`
--
...
--
-- Table structure for table `tblLocalizationPermission`
--
...
--
-- Table structure for table `tblLocalizationType`
--
...
--
-- Table structure for table `tblLogAlert`
--
...
--
-- Table structure for table `tblLogCostType`
--
...
--
-- Table structure for table `tblLogMonitoring`
--
...
--
-- Table structure for table `tblLogSavedSearch`
--
...
--
-- Table structure for table `tblLogSavedSearchUser`
--
...
--
-- Table structure for table `tblLogUser`
--
...
--
-- Table structure for table `tblLookupTableSync`
--
...
--
-- Table structure for table `tblMaintenanceType`
--
...
--
-- Table structure for table `tblMarketingProgram`
--
...
--
-- Table structure for table `tblMASourceCounter`
--
...
--
-- Table structure for table `tblMASourceListing`
--
...
--
-- Table structure for table `tblMASourceSeller`
--
...
--
-- Table structure for table `tblMASourceWarranty`
--
...
--
-- Table structure for table `tblMessageFolder`
--
...
--
-- Table structure for table `tblMeterReading`
--
...
--
-- Table structure for table `tblMeterReadingUnit`
--
...
--
-- Table structure for table `tblMilestonesResetThreshold`
--
...
--
-- Table structure for table `tblMiscCost`
--
...
--
-- Table structure for table `tblMiscCostType`
--
...
--
-- Table structure for table `tblMove`
--
...
--
-- Table structure for table `tblMoveAsset`
--
...
--
-- Table structure for table `tblMoveBack`
--
...
--
-- Table structure for table `tblMoveBackAsset`
--
...
--
-- Table structure for table `tblMoveSiteManager`
--
...
--
-- Table structure for table `tblMoveStatus`
--
...
--
-- Table structure for table `tblNetworkSettings`
--
...
--
-- Table structure for table `tblOrderRefund`
--
...
--
-- Table structure for table `tblOrderSystemProperty`
--
...
--
-- Table structure for table `tblPartsSelection`
--
...
--
-- Table structure for table `tblPasswordStorageVersion`
--
...
--
-- Table structure for table `tblPaymentProfile`
--
...
--
-- Table structure for table `tblPerRecordValue`
--
...
--
-- Table structure for table `tblPlanFeature`
--
...
--
-- Table structure for table `tblPlanFeatureCategory`
--
...
--
-- Table structure for table `tblPlanFeatureProductTier`
--
...
--
-- Table structure for table `tblPlatformEventType`
--
...
--
-- Table structure for table `tblPricingTier`
--
...
--
-- Table structure for table `tblPricingTierFeature`
--
...
--
-- Table structure for table `tblProductDiscountControl`
--
...
--
-- Table structure for table `tblProductOffering`
--
...
--
-- Table structure for table `tblProductOfferingFeature`
--
...
--
-- Table structure for table `tblProductTier`
--
...
--
-- Table structure for table `tblProductTimeTracking`
--
...
--
-- Table structure for table `tblProjectUser`
--
...
--
-- Table structure for table `tblPromotionalOffer`
--
...
--
-- Table structure for table `tblPromotionalOfferDetail`
--
...
--
-- Table structure for table `tblPromotionalOfferPricingTier`
--
...
--
-- Table structure for table `tblPTTxnThroughput`
--
...
--
-- Table structure for table `tblPurchaseOrderAdditionalCost`
--
...
--
-- Table structure for table `tblPurchaseOrderAdditionalCostType`
--
...
--
-- Table structure for table `tblPurchaseOrderLineItem`
--
...
--
-- Table structure for table `tblPurchaseOrderLineItemRfq`
--
...
--
-- Table structure for table `tblPurchaseOrderLog`
--
...
--
-- Table structure for table `tblPurchaseOrderStatus`
--
...
--
-- Table structure for table `tblPurchaseOrderStatusTransition`
--
...
--
-- Table structure for table `tblPurchaseOrderStatusTransitionPermission`
--
...
--
-- Table structure for table `tblPurchaseOrderUser`
--
...
--
-- Table structure for table `tblQuoteStatus`
--
...
--
-- Table structure for table `tblRateLimiterType`
--
...
--
-- Table structure for table `tblRCAAction`
--
...
--
-- Table structure for table `tblRCACause`
--
...
--
-- Table structure for table `tblRCAGrouping`
--
...
--
-- Table structure for table `tblRCAGroupingAction`
--
...
--
-- Table structure for table `tblRCAGroupingCause`
--
...
--
-- Table structure for table `tblRCAProblem`
--
...
--
-- Table structure for table `tblReasonToSetAssetOffline`
--
...
--
-- Table structure for table `tblReasonToSetAssetOnline`
--
...
--
-- Table structure for table `tblReceiptLineItem`
--
...
--
-- Table structure for table `tblReceiptStatus`
--
...
--
-- Table structure for table `tblReceiptStatusTransition`
--
...
--
-- Table structure for table `tblReconciliationControl`
--
...
--
-- Table structure for table `tblRecurringType`
--
...
--
-- Table structure for table `tblRegionUser`
--
...
--
-- Table structure for table `tblRegionUserGroup`
--
...
--
-- Table structure for table `tblRememberMeCookie`
--
...
--
-- Table structure for table `tblRemoteEntityIdMapping`
--
...
--
-- Table structure for table `tblReportCategory`
--
...
--
-- Table structure for table `tblReportHistory`
--
...
--
-- Table structure for table `tblReportPreset`
--
...
--
-- Table structure for table `tblReportPresetParameter`
--
...
--
-- Table structure for table `tblReportsToResolved`
--
...
--
-- Table structure for table `tblReportTemplate`
--
...
--
-- Table structure for table `tblResourceConsumer`
--
...
--
-- Table structure for table `tblResourceConsumerType`
--
...
--
-- Table structure for table `tblResourceNamespace`
--
...
--
-- Table structure for table `tblResourceService`
--
...
--
-- Table structure for table `tblRFQ`
--
...
--
-- Table structure for table `tblRFQAsset`
--
...
--
-- Table structure for table `tblRFQLineItem`
--
...
--
-- Table structure for table `tblRFQQueue`
--
...
--
-- Table structure for table `tblRFQStatus`
--
...
--
-- Table structure for table `tblRFQStatusTransition`
--
...
--
-- Table structure for table `tblRunCommandHistory`
--
...
--
-- Table structure for table `tblSalesAccountTracking`
--
...
--
-- Table structure for table `tblSalespersonType`
--
...
--
-- Table structure for table `tblScheduledJob`
--
...
--
-- Table structure for table `tblScheduledJobMonitor`
--
...
--
-- Table structure for table `tblScheduledMaintenance`
--
...
--
-- Table structure for table `tblScheduledMaintenanceActivityLog`
--
...
--
-- Table structure for table `tblScheduledMaintenanceAsset`
--
...
--
-- Table structure for table `tblScheduledMaintenanceBusiness`
--
...
--
-- Table structure for table `tblScheduledMaintenanceNesting`
--
...
--
-- Table structure for table `tblScheduledMaintenancePart`
--
...
--
-- Table structure for table `tblScheduledMaintenanceUser`
--
...
--
-- Table structure for table `tblScheduledReport`
--
...
--
-- Table structure for table `tblScheduledReportUser`
--
...
--
-- Table structure for table `tblScheduledTask`
--
...
--
-- Table structure for table `tblScheduledTaskFile`
--
...
--
-- Table structure for table `tblScheduleTrigger`
--
...
--
-- Table structure for table `tblServerSetting`
--
...
--
-- Table structure for table `tblShippingType`
--
...
--
-- Table structure for table `tblSiteAvailability`
--
...
--
-- Table structure for table `tblSiteStock`
--
...
--
-- Table structure for table `tblSiteUser`
--
...
--
-- Table structure for table `tblSiteUserGroup`
--
...
--
-- Table structure for table `tblSkin`
--
...
--
-- Table structure for table `tblSmtpEvent`
--
...
--
-- Table structure for table `tblSmtpEventType`
--
...
--
-- Table structure for table `tblSmtpProvider`
--
...
--
-- Table structure for table `tblSSOImplementation`
--
...
--
-- Table structure for table `tblSSOProvider`
--
...
--
-- Table structure for table `tblStockCycleCount`
--
...
--
-- Table structure for table `tblStockPurchaseItem`
--
...
--
-- Table structure for table `tblStockTxType`
--
...
--
-- Table structure for table `tblSubscriptionStatus`
--
...
--
-- Table structure for table `tblSystemMessageUser`
--
...
--
-- Table structure for table `tblSystemSetting`
--
...
--
-- Table structure for table `tblTaskFile`
--
...
--
-- Table structure for table `tblTaskGroup`
--
...
--
-- Table structure for table `tblTaskGroupAssetCategory`
--
...
--
-- Table structure for table `tblTaskResultConfiguration`
--
...
--
-- Table structure for table `tblTaskResultValue`
--
...
--
-- Table structure for table `tblTemplateCategory`
--
...
--
-- Table structure for table `tblTenantAutomation`
--
...
--
-- Table structure for table `tblTenantDashboard`
--
...
--
-- Table structure for table `tblTenantDeleteStatus`
--
...
--
-- Table structure for table `tblTenantDeleteTableNames`
--
...
--
-- Table structure for table `tblTenantDistributionCampaign`
--
...
--
-- Table structure for table `tblTenantFeature`
--
...
--
-- Table structure for table `tblTenantLineItem`
--
...
--
-- Table structure for table `tblTenantNotification`
--
...
--
-- Table structure for table `tblTenantNotificationPricingTier`
--
...
--
-- Table structure for table `tblTenantOrder`
--
...
--
-- Table structure for table `tblTenantOrderType`
--
...
--
-- Table structure for table `tblTenantPurgeRecordCount`
--
...
--
-- Table structure for table `tblTenantRelationship`
--
...
--
-- Table structure for table `tblTenantRelationshipType`
--
...
--
-- Table structure for table `tblTenantReport`
--
...
--
-- Table structure for table `tblTenantStatus`
--
...
--
-- Table structure for table `tblTenantSystemProperty`
--
...
--
-- Table structure for table `tblTenantSystemPropertyLog`
--
...
--
-- Table structure for table `tblTenantTransaction`
--
...
--
-- Table structure for table `tblTenantType`
--
...
--
-- Table structure for table `tblTenantWidget`
--
...
--
-- Table structure for table `tblTestingBlack`
--
...
--
-- Table structure for table `tblTestingRedC`
--
...
--
-- Table structure for table `tblTestingWhiteC`
--
...
--
-- Table structure for table `tblTestingYellow`
--
...
--
-- Table structure for table `tblTestTable`
--
...
--
-- Table structure for table `tblTheThrowable`
--
...
--
-- Table structure for table `tblTheThrowableReported`
--
...
--
-- Table structure for table `tblUicProfile`
--
...
--
-- Table structure for table `tblUsageLog`
--
...
--
-- Table structure for table `tblUserAnalyticsPermission`
--
...
--
-- Table structure for table `tblUserApiConsumerPermission`
--
...
--
-- Table structure for table `tblUserCertification`
--
...
--
-- Table structure for table `tblUserClockInOut`
--
...
--
-- Table structure for table `tblUserEpicFeatureNotice`
--
...
--
-- Table structure for table `tblUserGroupDashboardPersona`
--
...
--
-- Table structure for table `tblUserMASourceStart`
--
...
--
-- Table structure for table `tblUserMilestone`
--
...
--
-- Table structure for table `tblUserPurchaseOrderStatusTransitionPermission`
--
...
--
-- Table structure for table `tblUserReportsToUser`
--
...
--
-- Table structure for table `tblUserSystemProperty`
--
...
--
-- Table structure for table `tblUserSystemPropertyLog`
--
...
--
-- Table structure for table `tblV4Tenant`
--
...
--
-- Table structure for table `tblV5DataToV5EventsConversionStatus`
--
...
--
-- Table structure for table `tblV6ApiApplicationUserMapping`
--
...
--
-- Table structure for table `tblV6RolePermissionLookup`
--
...
--
-- Table structure for table `tblV6TenantUserInactivityTimeout`
--
...
--
-- Table structure for table `tblV6TenantUserMgmtMigration`
--
...
--
-- Table structure for table `tblV6UserDeletionTracking`
--
...
--
-- Table structure for table `tblWarrantyType`
--
...
--
-- Table structure for table `tblWarrantyUsageTermType`
--
...
--
-- Table structure for table `tblWorkflowActivity`
--
...
--
-- Table structure for table `tblWorkflowActivityType`
--
...
--
-- Table structure for table `tblWorkflowActivityTypeGroup`
--
...
--
-- Table structure for table `tblWorkflowComment`
--
...
--
-- Table structure for table `tblWorkflowExecution`
--
...
--
-- Table structure for table `tblWorkflowTriggerType`
--
...
--
-- Table structure for table `tblWorkflowTriggerTypeGroup`
--
...
--
-- Table structure for table `tblWorkOrder`
--
...
--
-- Table structure for table `tblWorkOrderAsset`
--
...
--
-- Table structure for table `tblWorkOrderBusiness`
--
...
--
-- Table structure for table `tblWorkOrderLog`
--
...
--
-- Table structure for table `tblWorkOrderPart`
--
...
--
-- Table structure for table `tblWorkOrderStatus`
--
...
--
-- Table structure for table `tblWorkOrderStatusTransition`
--
...
--
-- Table structure for table `tblWorkOrderTask`
--
...
--
-- Table structure for table `tblWorkOrderTaskAdditionalProperties`
--
...
--
-- Table structure for table `tblWorkOrderTaskFile`
--
...
--
-- Table structure for table `tblWorkOrderTaskUser`
--
...
--
-- Table structure for table `tblWorkOrderUser`
--
...
--
-- Table structure for table `tblYeMo`
--
...
--
-- Table structure for table `TokenEntry`
--
...
-- Dump completed on 2025-10-29 13:28:45
